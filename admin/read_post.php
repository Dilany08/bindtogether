...
if (isset($_POST['delete'])) {
    ...
    $delete_image_stmt->bind_param("i", $PostID);
...
<body>
    ...
    <section class="read-post">
        ...
        $select_posts_query = "SELECT * FROM `posts` WHERE `PostID` = ?";
    ...
    <section class="comments" style="padding-top: 0;">
        ...
        <div class="box-container">
            <?php
            $select_comments_query = "SELECT c.*, u.Avatar FROM `comments` c JOIN `users` u ON c.UserID = u.UserID WHERE c.PostID = ?";
                    ...
                    <div class="box">
                        <div class="user">
                            <div class="comment-img">
                                <img src="../upload/<?= htmlspecialchars($fetch_comments['Avatar']); ?>" alt="Profile Picture">
                            </div>
                            <div class="user-info">
