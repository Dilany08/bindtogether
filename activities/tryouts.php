...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Insert the form data into the tryouts table
    $sql = "INSERT INTO tryouts (ActivityID, UserID, Name, Email, StudNum, ContactNum, YearLevel, Program, College, Gender, Address, FatherName, MotherName, ParentContactNum, DateOfBirth, Height, Weight) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    $bind = $stmt->bind_param('issssssssssssssss', $ActivityID, $_SESSION['UserID'], $name, $email, $studNum, $contactNum, $yearLevel, $program, $college, $gender, $address, $fatherName, $motherName, $parentContactNum, $dob, $height, $weight);
