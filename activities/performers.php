...
<div class="container-one">
    ...
    <div class="grid">
        <?php
        $categories = [
            'Competitions' => 'performers_competitions.php',
            'Practices' => 'performers_practices.php',
            'Auditions' => 'performers_auditions.php'
        ];

        $images = [
            'Competitions' => '../img/competition.jpeg',
            'Practices' => '../img/dance.jpeg',
            'Auditions' => '../img/dancesport.jpg'
        ];
