...
<body>
    ...
    if (isset($_POST['search_box']) || isset($_POST['search_btn'])) {
        ...
        $select_posts = $conn->prepare("
            ...
            WHERE (p.Title LIKE ? OR p.Category LIKE ? OR a.Fname LIKE ? OR a.Lname LIKE ?) AND p.Status = ?
        ");
        $select_posts->bind_param('sssss', $search_param, $search_param, $search_param, $search_param, $Status);
