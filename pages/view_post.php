...
// Check if required fields are set for adding a comment
    ...
    <section class="posts-container" style="padding-bottom: 0;">
        <div class="box-container">
            ...
            if ($PostID) {
                ...
                $select_posts = $conn->prepare("SELECT posts.*, admins.Avatar AS post_Avatar, admins.Fname, admins.Lname, posts.MediaType, posts.MediaURL 
                                                FROM posts 
            ...
            ?>
                    ...
                    <button class="report-btn" name="report_post" onclick="reportPost(<?= htmlspecialchars($PostID); ?>)"><i class="fas fa-flag"></i></button> <!-- autogenerated by copilot, plz take care of the backend work -->
