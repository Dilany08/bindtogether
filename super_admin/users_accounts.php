...
<section class="accounts">
   ...
   <?php
      $conn = getDBConnection();
      $select_account = $conn->prepare("SELECT UserID, CONCAT(Fname, ' ', COALESCE(Mname, ''), ' ', Lname) AS name, Gender, Classification, Email, PhoneNum, Campus, BirthDate, Active FROM `users`");
